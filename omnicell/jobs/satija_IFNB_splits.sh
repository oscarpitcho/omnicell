...
MODEL_EMBEDDING_COMBOS=(
    ["flow"]="preprocess_and_BioBert preprocess_and_UCE_embedding"
    ["nearest-neighbor/nearest-neighbor_generic_substitute"]="preprocess_and_BioBert preprocess_and_UCE_embedding"
    ["nearest-neighbor/nearest-neighbor_gene_dist_substitute"]="preprocess"
)
...
run_job() {
    ...
    ETL_CONFIG="${CONFIG_BASE_DIR}/satija_IFNB_raw/ETL/${EMBEDDING}.yaml"
