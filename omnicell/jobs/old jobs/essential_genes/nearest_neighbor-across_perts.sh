...
python train.py --task_config configs/tasks/essential_genes/raw/essential_genes_across_genes_basic_ood.yaml \
    --model_config configs/models/nearest-neighbor/nearest-neighbor_substitute.yaml -l DEBUG

echo "Generating evaluations"

python generate_evaluations.py --model_name nearest-neighbor_substitute --task_name essential_genes_across_genes_basic_ood
