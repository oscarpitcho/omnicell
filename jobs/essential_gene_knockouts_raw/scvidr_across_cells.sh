...
#SBATCH --array=0-3        # CHANGE HERE TO MATCH SIZE OF CROSS PRODUCT: 1 Gene Embeddings x 4 Splits = 4 combinations 
...
MODEL_CONFIG="${CONFIG_BASE_DIR}/models/scVIDR.yaml"
MODEL_NAME="scVIDR"
