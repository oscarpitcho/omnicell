...
#SBATCH --mem=96GB
#SBATCH -p ou_bcs_low
#SBATCH --array=0-3       # 2 ETL configs x 2 Splits = 4 combinations
...
MODEL_CONFIG="${CONFIG_BASE_DIR}/models/scot/proportional_scot.yaml"  # Changed model
MODEL_NAME="proportional_scot"                                  # Updated model name
...
ETL_CONFIGS=("norm_drop_unmatched" "no_preproc_drop_unmatched")  # Added norm_drop_unmatched
SPLITS=(0 1)
